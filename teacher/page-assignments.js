...
window.PageAssignments = (function() {
  ...
  function setCollaboration(mode) { AC.setCollaboration(mode); _syncCollabState(); }
  function renderCollabPanel() { AC.renderCollabPanel(); }
  function collabToggleStudent(sid, checked) { AC.collabToggleStudent(sid, checked); }
  function collabCheckAll() { AC.collabCheckAll(); }
  function collabCheckNone() { AC.collabCheckNone(); }
  function collabRandomPairs() { AC.collabRandomPairs(); _syncCollabState(); }
  function collabRandomGroups() { AC.collabRandomGroups(); _syncCollabState(); }
  function collabSetGroupCount(delta) { AC.collabSetGroupCount(delta); _syncCollabState(); }
  function collabDragStart(e, sid, fromGroup) { AC.collabDragStart(e, sid, fromGroup); }
  function collabDrop(e, toGroup) { AC.collabDrop(e, toGroup); _syncCollabState(); }
  function loadCollabData(assess) { AC.loadCollabData(assess); _syncCollabState(); }
  function _resetCollabState() { AC.resetState(); _syncCollabState(); }
